...
**Run:** 2026-04-14T17:37:18.107356+00:00
**Model:** llama3.1
**Test cases:** 19
...
Tested on 19 cases. 8/19 contained complete traces with session ID, agent list, rule_ids, and quantified figures. Score: 71.1% (threshold: 80%).
...
Disposition bias leaked through compliance on: ['TC-19']. Score: 37.5% (threshold: 75%).
...
- Notes: Revisions: 1; MCP messages (28) exceeded max (20)
