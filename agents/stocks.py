...
IMPORTANT: Your analysis MUST include ESG screening commentary for every position recommended. This is a hard constraint — omitting ESG discussion will cause your response to be rejected.
